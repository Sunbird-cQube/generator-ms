...
def student_event_data():
    df_snap = df_data[['state_code', 'district_code', 'grade', 'subject', 'learning_outcome_code','students_surveyed']]
...
def performance_event_data():
    df_snap = df_data[['state_code', 'district_code', 'grade', 'subject', 'learning_outcome_code', 'performance']]
...
def learning_outcome_dimension_data():
    ...
    obj.upload_file(df_snap, 'lonas-dimension.data.csv')
