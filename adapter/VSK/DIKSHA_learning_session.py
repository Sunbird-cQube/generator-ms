...
def total_plays():
    df_snap = df_data[['state_code','grade','subject','medium','total_no_of_plays(App and Portal)']]
...
def avg_play_time():
    df_snap = df_data[['state_code','grade','subject','medium','average_play_time_in_mins(On App and Portal)']]
